    ...
    <div className="py-12 bg-black w-full">
      <div>
        <div className="text-center">
          <h2 className="text-base text-neutral-500 font-semibold tracking-wide uppercase">
            (FEATURED COURSES)
          </h2>
          <p className="mt-8 mb-24 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl">
            Learn With the Best
          </p>
        </div>
      </div>
